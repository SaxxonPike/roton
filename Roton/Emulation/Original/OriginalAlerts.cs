...
namespace Roton.Emulation.Original
{
    ...
    public sealed class OriginalAlerts : Alerts
    {
        private readonly IColors _colors;
        private readonly IFacts _facts;
        private readonly IMemory _memory;

        public OriginalAlerts(IMemory memory, IColors colors, IFacts facts)
        {
            _memory = memory;
            _colors = colors;
            _facts = facts;
        ...
        public override IMessage AmmoMessage => new Message($"Ammunition - {_facts.AmmoPerPickup} shots per container.");
