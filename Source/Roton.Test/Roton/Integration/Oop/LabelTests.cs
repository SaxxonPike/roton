...
public class LabelTests(Context context) : OopTestFixture(context)
{
    ...
    public void ZappingOwnLabels_ShouldProduceExpectedCode()
    {
        ...
        actors[0].Code.Span.ToStringValue().Should().Be(string.Join("\xD",
            "@yellow",
            "#zap label",
            "'label",
            ":label",
    ...
    public void ZappingRemoteLabels_ShouldProduceExpectedCode()
    {
        ...
        actors[1].Code.Span.ToStringValue().Should().Be(string.Join("\xD",
            "@blue",
            "'label",
            "'label",
            "#end"
        ));
        actors[2].Code.Span.ToStringValue().Should().Be(string.Join("\xD",
            "@green",
            "#restore blue:label",
            "'label",
            ":label",
        ...
        actors[3].Code.Span.ToStringValue().Should().Be(string.Join("\xD",
            "@green",
            ":label",
            ":label",
            "#end"
